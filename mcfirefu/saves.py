...
def select_bedrock_directory(prompt):
    """
...
def select_directory(directory, bedrock, prompt="Enter the number of the world you want to edit"):
    if directory:
        return directory
    elif bedrock:
        return select_bedrock_directory(prompt)
    else:
